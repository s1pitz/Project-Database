                ...
                <div class="bg-white border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md">
                    ...
                    <div class="overflow-x-auto">
                        <select name="3Types" id="3Types" onchange="nextpage(this)">
                            ...
                            <option value="deleteScreens/deleteMember.php">Member</option>
                            <option value="deleteScreens/deleteBook.php">Book</option>
                            <option value="deleteScreens/deleteBooking.php">Booking</option>
                        </select> <br>
                    </div>
                </div>
            </div>
