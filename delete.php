            ...
            <div class="grid grid-cols-1 gap-6 mb-6">
                <div class="bg-white border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md">
                    <div class="flex justify-between mb-4 items-start">
                        <div class="font-medium">Delete Data</div>
                    </div>
                    <div class="overflow-x-auto">
                        <select name="3Types" id="3Types" onchange="nextpage(this)">
                            <option value="" hidden>Select Option</option>
                            <option value="delete_screens/DeleteMember.php">Member</option>
                            <option value="delete_screens/DeleteBook.php">Book</option>
                            <option value="delete_screens/DeleteBooking.php">Booking</option>
                        </select> <br>
                    </div>
                </div>
            </div>
