            ...
            <div class="grid grid-cols-1 gap-6 mb-6">
                <div class="bg-white border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md">
                    <div class="flex justify-between mb-4 items-start">
                        <div class="font-medium">Search Book Title</div>
                    </div>
                    <div class="overflow-x-auto">
                        <form action="" method="POST">
                            <label for="JudulBuku">Book Title</label>
                            <input type="text" name="JudulBuku" style="border: 2px solid black; margin: 10px; required"> <br><br>
                                ...
                                <tr>
                                    <td class="py-2 px-4 border-b border-b-gray-50">
                                        <div class="flex items-center">
                                            <a href="#" class="text-gray-600 text-sm font-medium hover:text-blue-500 ml-2 truncate"><?= $title['IDBuku'] ?></a>
                                        </div>
                                    </td>
                                    <td class="py-2 px-4 border-b border-b-gray-50">
                                        <span class="text-[13px] font-medium text-gray-400"><?= $title['JudulBuku'] ?></span>
                                    </td>
                                    <td class="py-2 px-4 border-b border-b-gray-50">
                                        <span class="text-[13px] font-medium text-gray-400"><?= $title['Genre'] ?></span>
                                    </td>
                                    <td class="py-2 px-4 border-b border-b-gray-50">
                                        <span class="text-[13px] font-medium text-gray-400"><?= $title['TahunTerbit'] ?></span>
                                    </td>
                                </tr>
                                <?php endforeach?>
                            </tbody>
                        ...
                        <?php } ?>
                        <?php if($titles == NULL && isset($_POST["inputBtn"])){ ?>
