<?php
    ...
    if(isset($_POST["inputBtn"])){
        $names = getDataByMemberName($_POST);
    }
?>
            ...
            <div class="grid grid-cols-1 gap-6 mb-6">
                <div class="bg-white border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md">
                    <div class="flex justify-between mb-4 items-start">
                        <div class="font-medium">Search Member Name</div>
                    </div>
                    <div class="overflow-x-auto">
                        <form action="" method="POST">
                            <label for="NamaMember">Member Name</label>
                            <input type="text" name="NamaMember" style="border: 2px solid black; margin: 10px; required"> <br><br>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="py-2 px-4 border-b border-b-gray-50">
                                        <span class="text-[13px] font-medium text-gray-400"><?= $nam['IDMember'] ?></span>
                                    </td>
                                    <td class="py-2 px-4 border-b border-b-gray-50">
                                        <span class="text-[13px] font-medium text-gray-400"><?= $nam['NamaMember'] ?></span>
                                    </td>
                                    <td class="py-2 px-4 border-b border-b-gray-50">
                                        <span class="text-[13px] font-medium text-gray-400"><?= $nam['NoTelpon'] ?></span>
                                    </td>
                                    <td class="py-2 px-4 border-b border-b-gray-50">
                                        <span class="text-[13px] font-medium text-gray-400"><?php echo date("F j, Y", strtotime($nam['TanggalLahir'])); ?></span>
                                    </td>
                                </tr>
                                <?php endforeach?>
                            </tbody>
                        ...
                        <?php } ?>
                        <?php if($names == NULL && isset($_POST["inputBtn"])){ ?>
                            <br><span class="text-sm">Member Not Found</span>
                        <?php } ?>
                    </div>
                </div>
            </div>
