            ...
            <div class="grid grid-cols-1 gap-6 mb-6">
                <div class="bg-white border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md">
                    <div class="flex justify-between mb-4 items-start">
                        <div class="font-medium">Search Book</div>
                    </div>
                    <div class="overflow-x-auto">
                        ...
                        <select name="3Types" id="3Types" onchange="nextpage(this)">
                            ...
                            <option value="searchBookID.php">Book ID</option>
                            <option value="searchBookTitle.php">Book Title</option>
                            <option value="searchBookGenre.php">Genre</option>
                        </select> <br>
                    </div>
                </div>
            </div>
