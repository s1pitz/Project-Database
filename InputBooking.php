            ...
            <div class="grid grid-cols-1 gap-6 mb-6">
                <div class="bg-white border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md">
                    <div class="flex justify-between mb-4 items-start">
                        <div class="font-medium">Input Booking</div>
                    </div>
                    <div class="overflow-x-auto">
                        <form action="" method="POST">
                            ...
                            <input type="date" min="2023-01-01" name="TanggalPeminjaman" style="border: 2px solid black; margin: 10px; required"><br>
                            <label for="TanggalPengembalian">Tanggal Pengembalian</label>
                            <input type="date" min="2023-01-01" name="TanggalPengembalian" style="border: 2px solid black; margin: 10px; required"><br><br>
