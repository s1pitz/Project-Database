            ...
            <?php if($book != NULL){ ?>
                <div class="grid grid-cols-1 gap-6 mb-6">
                    <div class="bg-white border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md">
                        ...
                        <div class="overflow-x-auto">
                            <form action="" method="POST">
                                <span class="text-sm">Are You Sure You Want to Delete?</span>
                                <input type="text" value="<?=$book["IDBuku"]?>" readonly placeholder="<?=$book["IDBuku"];?>" name="IDBuku" style="border: 0px solid black; margin: 10px; required"> <br><br><br>
                                <button type="submit" name="deleteBtn" style="border-radius: 10px; width: 200px; height: 40px; background-color: #111827 ; color: white;">Yes</button>
                                <button type="submit" name="cancelBtn" style="border-radius: 10px; width: 200px; height: 40px; background-color: #111827 ; color: white;">No</button>
                            </form>
                        </div>
                    </div>
                </div>
